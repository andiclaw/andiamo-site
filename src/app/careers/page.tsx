  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-24 text-center">
      ...
      <p className="text-base text-slate-400 leading-relaxed mb-8 max-w-xl mx-auto">
        We&apos;re a small team and we&apos;re not actively recruiting. If you think you&apos;re a fit anyway, particularly if you bring something the team doesn&apos;t already have, we&apos;d still like to hear from you.
      </p>
      <Link
        href={`mailto:${COMPANY.supportEmail}?subject=Speculative%20application`}
